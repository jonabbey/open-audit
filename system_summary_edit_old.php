...
echo "<tr><td>Physical Location:&nbsp;</td><td><input type=\"text\" name=\"location\" size=\"20\" value=\"" . $s_m_l . "\" class=\"content\"></td></tr>\n";
echo "<tr bgcolor=\"#F1F1F1\"><td>Date of Purchase:&nbsp;</td><td><input type=\"text\" name=\"date\" size=\"20\" value=\"" . $s_m_d_o_p . "\" class=\"content\">(yyyy-mm-dd)</td></tr>\n";
echo "<tr><td>Dollar Value:&nbsp;</td><td><input type=\"text\" name=\"dollar\" size=\"20\" value=\"" . $s_m_v . "\" class=\"content\"></td></tr>\n";
echo "<tr bgcolor=\"#F1F1F1\"><td>Serial Number:&nbsp;</td><td><input type=\"text\" name=\"serial\" size=\"20\" value=\"" . $s_m_s_n . "\" class=\"content\"></td></tr>\n";
echo "<tr><td colspan=2 valign=\"top\">Description:<br><textarea rows=\"4\" name=\"description\" cols=\"60\" class=\"content\">" . $s_m_d . "</textarea></td></tr>\n";
