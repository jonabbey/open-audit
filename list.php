...
echo "<form method=\"POST\" name=\"form_nav\" action=\"".$_SERVER["REQUEST_URI"]."\">\n";
  ...
  echo "<table width=\"100%\" border=\"0\" height=\"70\"><tr><td>\n";
   echo "<span class=\"contenthead\"><b>";
   echo __($query_array["headline"])." ".$_REQUEST["headline_addition"];
   echo " (".$page_count."-".$show_page_count_to."/".$all_page_count.")</b></span>\n";
...
foreach($viewdef_array["fields"] as $field) {
    if($field["show"]=="y"){
        ...
        $headline_1 .= "<td nowrap style=\"padding-right:10px; font-weight:bold; border-bottom: 1px solid #000000;\" width=\"".$field["width"]."\" height=\"".$field["height"]."\" >";
        if($field["sort"]!="n"){
        ...
        if($sort==$field["name"]){
            $headline_1 .= "<img src=\"images/".strtolower($dir).".png\" style=\"padding-bottom:3px;\">";
        }
        $headline_1 .= "</td>\n";

        $headline_2 .= "<td style=\"padding-top:5px; padding-bottom:5px;\" name=\"search_boxes\">\n";
         if($field["search"]!="n"){
             $count_searchboxes++;
 ...
 $headline_1 .= "<a href=\"#\" onClick=\"show_hide_searchboxes();\"><img src=\"$image_searchboxes\" id=\"arrows_searchboxes\" border=\"0\" width=\"15px\" height=\"21px\"></a>";
 $headline_1 .= "</td>";
...
echo "<script type=\"text/javascript\">\n";
 echo "<!--\n";
  ...
  echo "function show_hide_searchboxes(){
            ...
            if(document.getElementById(\"searchboxes_1\").style.display == 'none'){
                ...
                action='none';
                var img_src='images/arrows_down.gif';
            }
            //Show Boxes
        ...
        foreach($query_array["fields"] as $field){
            ...
            if($field["show"]!="n"){
               ...
               while (list ($key, $val) = each ($myrow)) {
                ...
                if($field["image"]!=""){
                    echo "<img src=\"".$field["image"]."\" border=\"0\">";
                }else{
                    echo $show_value;
                }
                if($field["link"]=="y"){
