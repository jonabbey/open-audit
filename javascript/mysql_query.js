...
function setMysqlFields(obj,id,o_tbl) {
  ...
  http_request.open('POST', 'audit_config_mysql_ajax.php', true);
...
function addToQuery() {
  ...
  var t_obj = document.getElementById("mysql_tables");             // Original table select node
  ...
  var tbl  = document.getElementById("mysql_query_options");
