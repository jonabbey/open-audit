...
//                                                                                            Placekeeper for the All Dell Warranty link if it is needed 
      ...
      "45" => array("name"=>"Audits",
                    ...
                    "childs"=>array("10"=>array("name"=>"Manage Audits", "link"=>"./audit_manage.php", "image"=>"images/software.png", "title"=>"",),
                                    ...
                                    "40"=>array("name"=>"Web-Schedule Log", "link"=>"./list.php?view=ws_log", "image"=>"images/notes.png", "title"=>"",),
                                    "50"=>array("name"=>"Add Schedule", "link"=>"./audit_schedule.php", "image"=>"images/sched_task_l.png", "title"=>"",),
                                    "60"=>array("name"=>"Add Configuration", "link"=>"./audit_configuration.php", "image"=>"images/o_specialized.png", "title"=>"",),
                                    "70"=>array("name"=>"Edit Commands", "link"=>"./audit_commands.php", "image"=>"images/o_specialized.png", "title"=>"",),
                              ),
              ),
