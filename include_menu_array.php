  ...
  "misc" => array(
      ...
      "10" => array("name"=>"Queries",
                    ...
                    "childs"=>array("10"=>array("name"=>"All Audited Systems", "link"=>"./list.php?view=all_systems", "image"=>"images/computer.png", "title"=>"All Audited Systems",),
                                    ...
                                    "130"=>array("name"=>"All Windows Shares", "link"=>"./list.php?view=all_network_shares&amp;type=windows%&amp;headline_addition=Windows", "image"=>"images/shared_drive_l.png", "title"=>"All Windows Shares by Host",),
                              ),
              ),
