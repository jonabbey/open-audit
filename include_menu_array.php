...
/*                                  This next bit wont work, we need a Parameter for each choice FIXME
      ...
      "40" => array("name"=>"Admin",
                    ...
                    "childs"=>array("10"=>array("name"=>"Config", "link"=>"admin_config.php?sub=1", "image"=>"images/settings.png", "title"=>"",),
                                    ...
                                    "70"=>array("name"=>"Backup Database", "link"=>"database_backup.php", "image"=>"images/tape.png", "title"=>"",),
                                    "80"=>array("name"=>"Restore Database", "link"=>"database_restore.php", "image"=>"images/tape.png", "title"=>"",),
                              ),
              ),
  ),
);
