...
?>
  ...
  <span class="contenthead"><?php echo $l_ocd; ?></span><br /><br />
<?php
$sql = "SELECT ms_keys_name, ms_keys_cd_key, system_name, net_ip_address, system_uuid FROM ms_keys, system WHERE ms_keys_key_type NOT LIKE 'office%' AND ms_keys_key_type NOT LIKE 'windows%' AND ms_keys_uuid = system_uuid AND ms_keys_timestamp = system_timestamp ORDER BY " . $sort . " LIMIT " . $page_count . "," . $count_system;
$result = mysql_query($sql, $db);
if ($myrow = mysql_fetch_array($result)){
  echo "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n";
  echo " <tr>\n";
  echo "  <td align=\"center\"><a href=\"list_other_keys.php?sub=" . $sub . "&amp;sort=net_ip_address\">$l_ipa</a></td>\n";
  echo "  <td align=\"center\"><a href=\"list_other_keys.php?sub=" . $sub . "&amp;sort=system_name\">$l_nam</a></td>\n";
  echo "  <td align=\"center\"><a href=\"list_other_keys.php?sub=" . $sub . "&amp;sort=ms_keys_name\">$l_swf</a></td>\n";
