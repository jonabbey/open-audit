...
$query_array=array("name"=>__("Other System"),
                   ...
                   "views"=>array("summary"=>array(
                                                    ...
                                                    "fields"=>array(
                                                                    ...
                                                                    "40"=>array("name"=>"other_ip_address", "head"=>__("IP Address"), "edit"=>"y",),
                                                                    "50"=>array("name"=>"other_mac_address", "head"=>__("MAC Address"), "edit"=>"y",),
                                                                    "60"=>array("name"=>"other_timestamp", "head"=>__("Date First Audited"), "edit"=>"n",),
                                                                    "70"=>array("name"=>"other_manufacturer", "head"=>__("Manufacturer"), "edit"=>"y",),
                                                                    "80"=>array("name"=>"other_model", "head"=>__("Model"), "edit"=>"y",),
                                                                    "90"=>array("name"=>"other_serial", "head"=>__("Serial"), "edit"=>"y",),
                                                                    "100"=>array("name"=>"other_location", "head"=>__("Location"), "edit"=>"y",),
                                                                    "110"=>array("name"=>"other_date_purchased", "head"=>__("Date of Purchase"), "edit"=>"y",),
                                                                    "120"=>array("name"=>"other_value", "head"=>__("Dollar Value"), "edit"=>"y",),
                                                                    "130"=>array("name"=>"other_description", "head"=>__("Description"), "edit"=>"y",),
                                                                    "140"=>array("name"=>"other_p_port_name", "head"=>__("Port-Name"), "edit"=>"y",),
                                                                   ),
                                                    ),
                                   "nmap"=>array(
