...
<table width="100%">
  <tr>
        <td style="border: none; background-image: url(images/grad.png); background-repeat: repeat-x;" colspan="3" class="main_each"><a href="index.php"><img src="images/logo.png" width="300" height="48" alt="" style="border:0px;" /></a></td>
  </tr>
