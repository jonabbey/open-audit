...
$query_array=array("name"=>array("name"=>__("User"),
                   ...
                   "views"=>array("manual"=>array(
                                                    ...
                                                    "fields"=>array("10"=>array("name"=>"auth_id",
                                                                    ...
                                                                    "30"=>array("name"=>"auth_hash", "head"=>__("Password"), "edit"=>"y",),
                                                                    "40"=>array("name"=>"auth_realname", "head"=>__("Realname"), "edit"=>"y",),
                                                                    "50"=>array("name"=>"auth_enabled", "head"=>__("Auth Enabled "), "edit"=>"y",),
                                                                    "60"=>array("name"=>"auth_admin", "head"=>__("Admin"), "edit"=>"y","edit_type"=>"textarea",),
                                                                   ),
                                                ),
