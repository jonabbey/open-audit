...
if(!(isset($_POST['submit']))){
  ...
  echo "          <tr>\n";
  echo "            <td>$l_s02 ?</td>\n";
  echo "            <td><input size=\"20\" name=\"mysql_host\" value=\"localhost\" /></td>\n";
  echo "          </tr>\n";
  echo "          <tr>\n";
  echo "            <td>$l_s03 ?</td>\n";
  echo "            <td><input size=\"20\" name=\"mysql_user\" value=\"root\" /></td>\n";
  echo "          </tr>\n";
  echo "          <tr>\n";
  echo "            <td>$l_s04 ?</td>\n";
  echo "            <td><input size=\"20\" name=\"mysql_pass\" /></td>\n";
  echo "          </tr>\n";
  echo "          <tr>\n";
  echo "            <td>$l_s05 ?</td>\n";
  echo "            <td><input size=\"20\" name=\"mysql_data\" value=\"openaudit\" /></td>\n";
  echo "          </tr>\n";
  echo "          <tr>\n";
  echo "            <td>$l_s17 ?</td>\n";
  echo "            <td><select size=\"1\" name=\"usernames\">\n";
  ...
  echo "          <tr>\n";
  echo "            <td>$l_usn:</td>\n";
  echo "            <td><input size=\"20\" name=\"username\" value=\"admin\" /></td>\n";
  echo "          </tr>\n";
  echo "          <tr>\n";
  echo "            <td>$l_pas:</td>\n";
  echo "            <td><input size=\"20\" name=\"password\" value=\"Open-AudIT\" /></td>\n";
  echo "          </tr>\n";
  ...
  // or die ("</tr><tr><td><font color=\"red\">" . $sql3 . "</font></td></tr><tr><td colspan=\"2\"><h3>MySQL Error:</h3> " . mysql_error() . "</td></tr><tr>\n");
  }
  echo "<td>$l_doe.</td></tr>\n";
